...
inline void registerxlInitiateFloatLegAustralia(const XLOPER & xDll) {

             // Enregistre la fonction xlInitiateFloatLegAustralia
        Excel(xlfRegister, 0, 21, & xDll,
            TempStrNoSize("\x1B""xlInitiateFloatLegAustralia"),
            TempStrNoSize("\x0D""PCEPPEPCPPPP#"),
            TempStrNoSize("\x21""INSTANCE.JAMBE.VARIABLE.AUSTRALIE"),
            ...
            TempStrNoSize("\x00"""),
            TempStrNoSize("\x00"""),
            TempStrNoSize("\x49""Cette fonction instancie une jambe variable de swap en dollar australien."),
...
inline void unregisterxlInitiateFloatLegAustralia(const XLOPER & xDll) {
